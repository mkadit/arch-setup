# Generated by Powerlevel10k configuration wizard on 2020-07-06 at 18:40 WIB.
...
# disconnected, left frame, dark, sparse, many icons, concise, instant_prompt=off.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND="AS"
  # Make the icon bold.
