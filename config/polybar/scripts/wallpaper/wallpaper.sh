...
WALLPAPERS_PATH=$HOME/Pictures/wallpaper/wallpaper_script
GIF_PATH=$WALLPAPERS_PATH/gifs-frames

DAY_WALL=$WALLPAPERS_PATH/
NIGHT_WALL=$WALLPAPERS_PATH/nord-water.png
PRESET=$WALLPAPERS_PATH/Hoshimachi_Suisei_preset.jpg
...
random() {
    file=$(find "$WALLPAPERS_PATH" -type f -print0 | shuf -z -n 1)
    setbg "$file"
